...
class Fish: SKSpriteNode {
    ...
    static func allFishes() -> [Fish] {
        let fishes: [Fish] = [
            ...
            Fish(imageName: "mackerelCommon", fishName: "mackarelCommon", bonusLives: 1, bonusAttack: 0, bonusSpeed: 0, specialPower: SpecialPower(name: "Fresh Sashimi", cooldown: 100), rarity: .common),
            Fish(imageName: "mackerelUncommon", fishName: "mackarelUncommon", bonusLives: 2, bonusAttack: -0.1, bonusSpeed: -1, specialPower: SpecialPower(name: "Fresh Sashimi", cooldown: 120), rarity: .uncommon),
            Fish(imageName: "mackerelRare", fishName: "mackarelRare", bonusLives: 2, bonusAttack: 0, bonusSpeed: 0, specialPower: SpecialPower(name: "Fresh Sashimi", cooldown: 150), rarity: .rare),
